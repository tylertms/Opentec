...
enum {
    ...
    THROTTLE_MARKER_OFFSET = 0x15,
    CLUTCH_MARKER_OFFSET = 0x1f,
    ADJUSTED_MARKER = 'X',
    UNADJUSTED_TAIL_FIRST = 0xbf,
    UNADJUSTED_TAIL_SECOND = 0x77,
};
 ...
 * that order. A valid response without either marker reports both pedals adjusted.
 *
 ...
 * @return True when the response is long enough to classify.
 */
