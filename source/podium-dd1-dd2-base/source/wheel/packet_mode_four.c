 ...
 *
 * Writes command A5, three display glyphs, the optional third-glyph marker, two display-state
 * bytes, and two legacy-axis bytes.
 *
 * @param[in] output Current display output, display state, and legacy axes.
