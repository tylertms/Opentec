...
enum {
    MEMORY_TRANSFER_CONTROL_COMMAND = 2,
    MEMORY_TRANSFER_READ_FLAG = 1,
    MEMORY_TRANSFER_RESPONSE_REJECTED = 0,
    MEMORY_TRANSFER_RESPONSE_ACCEPTED = 1,
    MEMORY_TRANSFER_READ_DATA_OFFSET = 2,
};
