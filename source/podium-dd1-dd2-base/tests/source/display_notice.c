...
static void test_renders_official_overlay_assets(void) {
    ...
    assert(pixel(framebuffer, 126, 17) == 11);
    assert(pixel(framebuffer, 127, 17) == 4);
    assert(pixel(framebuffer, 128, 17) == 0);
    assert(pixel(framebuffer, 129, 17) == 4);
    assert(pixel(framebuffer, 130, 17) == 11);
    ...
    assert(pixel(framebuffer, 127, 17) == 1);
}
...
static void test_renders_unsupported_wheel_alert_variants(void) {
    ...
    assert_filled_overlay(inverted);
    ...
    assert(pixel(outlined, 126, 17) == 4);
    assert(has_dark_pixel(inverted, 2, 30, 251, 10));
    assert(has_dark_pixel(inverted, 2, 40, 251, 10));
    assert(has_lit_pixel(outlined, 2, 30, 251, 10));
    assert(has_lit_pixel(outlined, 2, 40, 251, 10));
}

int main(void) {
    test_renders_persistent_notice_layout();
    test_renders_official_overlay_assets();
